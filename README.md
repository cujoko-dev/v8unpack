...
3. Создать и отправить четырёхкомпонентный тег, например `3.1.0.0`.

Публичная версия, Git-тег и числовые свойства Windows EXE используют одинаковые
четыре компонента (`3.1.0.0`).
