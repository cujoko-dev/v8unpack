...
Portable-релизы распространяются в архивах
`v8unpack-<version>-win-x64-built-by-cujoko.zip`.

Архив содержит `v8unpack.exe`, README, лицензию и файл контрольных сумм.
