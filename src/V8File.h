...
const int V8UNPACK_UNSAFE_ELEMENT_NAME = V8UNPACK_ERROR - 5;
...
const int V8UNPACK_DEFLATE_IN_FILE_NOT_FOUND = V8UNPACK_DEFLATE_ERROR - 1;
const int V8UNPACK_DEFLATE_OUT_FILE_NOT_CREATED = V8UNPACK_DEFLATE_ERROR - 2;
